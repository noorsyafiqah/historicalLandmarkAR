...
public class augmentedScriptPanel : MonoBehaviour
{
    ...
    public void Calc(float lat1, float lon1, float lat2, float lon2)
    {
        ...
        //set the target position of the historical landmark, this is where we lerp to in the update function
        targetPosition = originalPosition - new Vector3(0, 0, distanceFloat * 12);
        //distance was multiplied by 12 
